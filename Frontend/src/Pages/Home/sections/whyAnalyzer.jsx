...
const WhyAnalyzer = () => {
    ...
    return (
        <section className='w-full p-2 mt-10  ' id='whyAnalyzer'>
            ...
            <div className='flex p-2 flex-col lg:flex-row rounded-lg py-5 shadow-sm'>

                <div className='w-full lg:w-1/3  p-2'>
                    <p className=' text-3xl font-bold'>Stop guessing what is </p>
                    <p className='text-2xl text-gray-400 font-bold'>wrong with your resume.</p>
                </div>
                ...
                <div className=' w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-3 gap-4'>
                    ...
                    {whyAnalyzeData.map((rw, i) => {
                        ...
                        return (
                            ...
                            <div
                                className='flex flex-col justify-evenly p-4 min-h-60 bg-mist-100/40 shadow-lg rounded-lg'
                                key={i}
                            >
